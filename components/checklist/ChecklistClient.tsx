...
export function ChecklistClient({ careGroupId, recipientName, items, todayCompletions, currentUserId }: Props) {
  ...
  // Map of item ID → completion record (for showing who completed it)
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {format(new Date(), 'EEEE, MMMM d')} · caring for {recipientName}
          </p>
        </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-14 gap-3 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground/70 mt-0.5">Add the daily tasks you want to track for {recipientName}</div>
            </div>
